            ...
            {isOpen && (
                <>
                    ...
                    <motion.div
                        ...
                        className="absolute right-0 top-full mt-2 w-80 sm:w-96 !bg-white dark:!bg-slate-900 rounded-xl shadow-2xl border border-slate-200 dark:border-slate-800 z-[100] overflow-hidden flex flex-col max-h-[500px]"
                    >
                        ...
                        <div className="overflow-y-auto custom-scrollbar flex-1 bg-white dark:bg-slate-900">
                            {notifications.length === 0 ? (
                                <div className="flex flex-col items-center justify-center py-12 text-center px-6 bg-white dark:bg-slate-900">
                                ...
                                <div className="divide-y divide-slate-100 dark:divide-slate-800 bg-white dark:bg-slate-900">
                                    {notifications.map((notif) => (
                                        <div 
                                            key={notif.id} 
                                            className={`p-4 hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors relative group ${notif.read ? 'opacity-60 bg-white dark:bg-slate-900' : 'bg-blue-50/30 dark:bg-blue-900/10'}`}
                                        >
